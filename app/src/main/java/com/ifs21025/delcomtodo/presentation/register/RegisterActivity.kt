package com.ifs21025.delcomtodo.presentation.register
...
import com.ifs21025.delcomtodo.databinding.ActivityRegisterBinding
            ...
            if (result != null) {
                when (result) {
                    ...
                    is MyResult.Success -> {
                        ...
                        AlertDialog.Builder(this).apply {   setTitle("Yeah!")
